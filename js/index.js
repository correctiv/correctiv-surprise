...
var Slider = (function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      return _react2['default'].createElement(_reactSlider2['default'], {
...
},{"react":161,"react-slider":6}],2:[function(require,module,exports){
'use strict';
...
var Renderer = (function () {
  ...
  _createClass(Renderer, [{
    ...
    key: '_updateColors',
    value: function _updateColors(el, value, className) {
      _d32['default'].select(el).selectAll('circle').classed(className, function (d) {
        return d < value;
      });
    }
  }]);
...
var Visualization = (function (_React$Component) {
  ...
  function Visualization(props) {
    ...
    _get(Object.getPrototypeOf(Visualization.prototype), 'constructor', this).call(this, props);
  }
...
},{"d3":5,"react":161}],3:[function(require,module,exports){
'use strict';
...
var Surprise = (function (_React$Component) {
  ...
  function Surprise(props) {
    ...
    _get(Object.getPrototypeOf(Surprise.prototype), 'constructor', this).call(this, props);
    this.state = {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_componentsSlider2['default'], {
          ...
          onChange: function (value) {
            return _this._handleChange(value);
          }
        })
      );
    }
...
window.Surprise = {
  render: function render(el, options) {
    _react2['default'].render(_react2['default'].createElement(Surprise, options), el);
  },
  renderStatic: function renderStatic(el, options) {
    _react2['default'].render(_react2['default'].createElement(_componentsVisualization2['default'], options), el);
  }
};

},{"./components/slider":1,"./components/visualization":2,"react":161}],4:[function(require,module,exports){
